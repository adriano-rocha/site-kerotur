...
function Contact() {
  ...
  return (
    <section
      id="contato"
      className="py-16 md:py-24 bg-linear-to-b from-blue-50 to-white"
    >
      <div className="container mx-auto px-4">
        {/* Título */}
        <div className="text-center mb-12">
          <h2
            className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-blue-600"
            data-aos="fade-down"
          >
            {t("contact.title")}
          </h2>
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div
              data-aos="fade-right"
              data-aos-delay="200"
              className="bg-white rounded-xl p-4 shadow-md border border-gray-200 hover:border-blue-300 transition-all duration-300"
            >
              <div className="flex items-center gap-3">
            ...
            <div
              data-aos="fade-right"
              data-aos-delay="300"
              className="bg-white rounded-xl p-4 shadow-md border border-gray-200 hover:border-yellow-300 transition-all duration-300"
            >
              <div className="flex items-center gap-3">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-6 lg:p-8 text-white text-center shadow-xl">
              ...
              <p className="mb-5 text-blue-100 text-sm lg:text-base">
