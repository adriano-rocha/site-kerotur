...
function Footer() {
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="border-t border-[#00008B]/30 mt-5 pt-4">
                <button
                  onClick={() => setIsCancellationOpen(true)}
                  className="text-sm font-semibold text-[#00008B] border border-[#00008B] rounded-lg px-3 py-2 hover:bg-[#00008B] hover:text-white transition duration-300 flex items-center gap-2 w-full justify-center"
                >
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-[#00008B]">
                <li className="flex items-start gap-2">
                  <svg
                    className="w-5 h-5 text-[#00008B] shrink-0 mt-0.5"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <li className="flex items-center gap-2">
                  <svg
                    className="w-5 h-5 text-[#00008B] shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
        ...
        <div className="border-t-2 border-[#00008B]">
          <div className="container mx-auto px-4 py-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-center text-sm">
              <p className="text-[#00008B] text-center md:text-left">
                © {currentYear}{" "}
                <span className="text-[#00008B] font-semibold">
              ...
              {/*<p className="text-[#00008B] text-xs">
                ...
                <a href="https://i9criacaodesite.com.br" target="_blank" rel="noopener noreferrer"
      ...
      {isCancellationOpen && (
        <CancellationModal onClose={() => setIsCancellationOpen(false)} />
      )}
    </>
  );
}
