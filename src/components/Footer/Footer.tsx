        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#sobre" className="hover:text-yellow-300 transition duration-300">
                  {t('header.aboutUs')}
                </a>
              </li>
              <li>
                <a href="#passeios" className="hover:text-yellow-300 transition duration-300">
                  {t('header.tours')}
                </a>
              </li>
              <li>
                <a href="#parceiros" className="hover:text-yellow-300 transition duration-300">
                  {t('header.partners')}
                </a>
              </li>
              <li>
                <a href="#contato" className="hover:text-yellow-300 transition duration-300">
                  {t('header.contact')}
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>Rua Noronha Torrezão, 282/1002B<br/>CEP 24240-182, Niterói – RJ</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+5521982251450" className="hover:text-yellow-300 transition duration-300">
                  +55 21 98225-1450
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <a href="mailto:kerotur@kerotur.com" className="hover:text-yellow-300 transition duration-300">
                    kerotur@kerotur.com
                  </a>
                  <a href="mailto:kerotur@yahoo.com" className="hover:text-yellow-300 transition duration-300">
                    kerotur@yahoo.com
                  </a>
                </div>
              </li>
          ...
          <div>
            <h4 className="text-lg font-bold text-white mb-4">{t('footer.businessHours')}</h4>
            <ul className="space-y-2 text-sm">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p className="text-gray-400">
              © {currentYear} <span className="text-yellow-300 font-semibold">Kerotur Turismo e Eventos</span>. {t('footer.rights')}
            </p>
            <p className="text-gray-400">
              CNPJ: 48.285.913/0001-28
            </p>
            <p className="text-gray-500 text-xs">
              {t('footer.developedBy')} <a href="https://i9criacaodesites.com" target="_blank" rel="noopener noreferrer" className="text-yellow-300 hover:text-yellow-400 transition">I9 Criação de Sites</a>
            </p>
          </div>
        </div>
      </div>
