      ...
      <header className="bg-white text-[#0008B] sticky top-0 z-50 shadow-lg">
        ...
        <div
          className={`bg-[#FF8C00] border-b border-orange-400 transition-all duration-300 ${
            isScrolled ? "h-0 opacity-0 overflow-hidden" : "h-20 sm:h-16"
          }`}
        >
          <div className="container mx-auto px-4 py-3 sm:py-2 flex items-center h-full">
            <div className="flex flex-col md:flex-row justify-between items-center gap-3 w-full text-sm md:text-base">
              ...
              {/* Redes Sociais — bg azul marinho fixo, hover colorido por rede */}
              <div className="flex gap-2 items-center">
                ...
                <a
                  ...
                  className="w-8 h-8 bg-[#00008B] hover:bg-green-700 text-white rounded-full flex items-center justify-center transition duration-300"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-[#00008B] hover:bg-pink-600 text-white rounded-full flex items-center justify-center transition duration-300"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-[#00008B] hover:bg-blue-600 text-white rounded-full flex items-center justify-center transition duration-300"
                  aria-label="Facebook"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                    <path
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-[#00008B] hover:bg-green-500 text-white rounded-full flex items-center justify-center transition duration-300"
                  aria-label="Linktree"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                    <path
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-[#00008B] hover:bg-green-600 text-white rounded-full flex items-center justify-center transition duration-300"
                  aria-label="WhatsApp"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                      ...
                      <span
                        className={`text-sm font-medium transition-all duration-300 ${
                          i18n.language === lang.code
                            ? "bg-linear-to-r from-[#00ffff] to-[#00bfff] bg-clip-text text-transparent font-bold"
                            : "hover:text-[#00ffff]"
                        }`}
                      >
                        {lang.name}
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 max-h-96 overflow-y-auto">
                  {languages.map((lang) => (
                    <button
                      ...
                      onClick={() => changeLanguage(lang.code)}
                      className={`w-full px-4 py-2 text-left flex items-center gap-3 hover:bg-gray-50 transition ${
                        i18n.language === lang.code ? "bg-[#00ffff]/20" : ""
                      }`}
                    >
                      <img
                        src={`/flags/${lang.flag}`}
        ...
        {isMenuOpen && (
          <ul className="lg:hidden mt-4 space-y-3 pb-4 border-t border-gray-200 pt-4 font-semibold px-4">
            ...
            <li>
              ...
              {isToursDropdownOpen && (
                <ul className="mt-2 ml-4 space-y-2 max-h-48 overflow-y-auto">
                  {toursData.map(
